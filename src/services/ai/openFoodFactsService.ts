...
const categoryToAppCategory = (categories?: string[]): string | null => {
  ...
  if (cat.includes('dairy') || cat.includes('milk') || cat.includes('lacteo') || cat.includes('cheese') || cat.includes('queso') || cat.includes('yogur')) return 'Lácteos y Derivados';
  if (cat.includes('egg') || cat.includes('huevo')) return 'Huevos';
  if (cat.includes('tomato') || cat.includes('tomate') || cat.includes('tomatoes')) return 'Verduras y Tubérculos';
  if (cat.includes('vegetable') || cat.includes('verdura') || cat.includes('vegetal')) return 'Verduras y Tubérculos';
  ...
  if (cat.includes('nut') || cat.includes('frutos secos') || cat.includes('seed')) return 'Frutos Secos';
  if (cat.includes('cereal') || cat.includes('grain') || cat.includes('oat') || cat.includes('avena') || cat.includes('rice') || cat.includes('arroz')) return 'Cereales y Legumbres';
  if (cat.includes('bread') || cat.includes('pan') || cat.includes('pasta') || cat.includes('dough') || cat.includes('masa')) return 'Panadería';
